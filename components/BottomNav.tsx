  ...
  return (
    ...
    >
      <div className="max-w-md mx-auto">
        <div className="bg-white rounded-full shadow-2xl border-2 border-[#E6C288] px-2">
            ...
            {navItems.map((item) => {
              ...
              if (item.isCenter) {
                return (
                  <div
                    key={item.name}
                    className="flex flex-col items-center justify-center relative min-w-[60px]"
                  >
                    <button
                      onClick={openModal}
                      className="w-14 h-14 bg-[#4A3B32] rounded-full flex items-center justify-center shadow-lg hover:bg-[#4A3B32]/90 active:scale-95 transition-all absolute -top-7"
              ...
              const className = `flex flex-col items-center justify-center min-w-[60px] py-2 px-2 rounded-full transition-all relative ${
                isActive
                  ? "text-[#4A3B32] bg-[#E6C288]/20"
